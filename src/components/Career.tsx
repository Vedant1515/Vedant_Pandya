        ...
        <div className="career-info">
          ...
          <div className="career-info-box">
            ...
            <p>
              ...
              projects. Designed an ML-driven Python application to process and
              visualise interferograms, improving workflow efficiency by ~25%.
              Applied data analysis techniques to manage complex scientific datasets
              and presented progress in weekly review meetings.
            </p>
          </div>
          <div className="career-info-box">
            <div className="career-info-in">
